...
public class PublicacionGuardadosRecyclerAdapter(val mContext: Context, var publicaciones: List<Publicaciones>):
    RecyclerView.Adapter<PublicacionGuardadosRecyclerAdapter.MyViewHolder>(), View.OnClickListener {
